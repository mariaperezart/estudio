...
| Idea recibida | Se queda | Por qué |
|---|---|---|
| Estructurar por "Día X" en vez de temporadas | Se queda, matizada | Ya es como Gabriela quiere narrar el tiempo — pero sin comprometerse a publicar todos los días exista o no algo que contar |
...
- un experimento que cerrar,
- o un dato que compartir.

Si pasan dos semanas sin nada real que contar, no hay episodio — y eso también es información (se puede decir así, en un episodio corto: "esta semana no hay descubrimiento, solo trabajo de fondo"). Esto protege el canon (Manifiesto §21: no crear contenido que no represente el universo) y evita la "jaula del calendario" que señala correctamente el material analizado.
...
| Categoría | Función | Encaja en | Plantilla obligatoria |
|---|---|---|---|
| **Diario** | Avance concreto: qué se hizo hoy | 60% descubrimiento | Un hecho + qué significa, sin forzar hipótesis si no la hay |
...
| Hook | Cuándo usarlo | Ejemplo aplicado (no promete resultado) |
|---|---|---|
...
> **Una pregunta (Manifiesto) + una investigación (§12) + una prueba pública (esta serie) — sin prometer un resultado que todavía no existe.**
...
- Founder-forward en el sentido correcto para arte contemporáneo: la trayectoria y la forma de pensar de Gabriela son parte del valor de la obra (Manifiesto §13), no contenido de vida personal desconectado de ella.
...
```
INFORME — [periodo cubierto]

Hipótesis comprobadas:     [nº, de BIBLIA_DEL_UNIVERSO.md §12/§13]
Hipótesis rechazadas:      [nº]
Experimentos en curso:     [nº]
Obras terminadas:          [nº]
Dossiers enviados:         [nº, solo si es real]
Respuestas recibidas:      [nº, solo si es real]

La idea que más cambió mi forma de pensar este periodo:
[una frase, real]

La siguiente pregunta que quiero responder:
[una frase, real]
```
...
- [ ] Si quito la música, la edición y la tipografía bonita, ¿queda una idea real?
- [ ] ¿Estoy afirmando algo que no ha pasado todavía? (si sí — no se publica hasta que sea verdad)
- [ ] ¿Este episodio decepcionaría a alguien que ya vio los anteriores, o aporta algo nuevo?
- [ ] ¿Estoy usando un tono de autoridad sobre algo que en realidad todavía es una hipótesis sin validar? (si sí — se marca explícitamente como hipótesis, igual que en `BIBLIA_DEL_UNIVERSO.md` §13)
- [ ] ¿Esto representa el universo (Manifiesto §21), o solo persigue una métrica a corto plazo?

`director-marca` aplica este checklist antes de cualquier publicación, igual que ya hace con el resto de contenido (`BIBLIA_DEL_UNIVERSO.md` §8).
