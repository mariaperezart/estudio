...
*Versión operativa, para usar mientras grabas y publicas. No sustituye a `BIBLIA_DEL_UNIVERSO.md` (que sigue siendo la fuente de verdad si algo aquí parece contradecirla) — es ese documento condensado en algo que puedas tener abierto en el móvil antes de grabar.*

---

## 0. Antes de nada

Si alguna vez dudas si algo "encaja con la marca", esta es la pregunta rápida:
...
Si la respuesta es lo segundo, no se publica, aunque funcione. (Manifiesto §21, `BIBLIA_DEL_UNIVERSO.md` §14.)

---

## 1. Quién eres, en una página
...
- **Tu lente, no tu tema**: tu forma de percibir, influida por ser autista, es una de las lentes con las que miras — nunca el tema de la obra ni el gancho de un vídeo (Manifiesto §6, `BIBLIA_DEL_UNIVERSO.md` §3). Se menciona cuando aporta algo real a la idea, nunca como titular.

---

## 2. Identidad visual aplicada a redes
...
- [ ] ¿Hay alguna palabra de la lista prohibida (sección 3)?
- [ ] ¿Esto es coherente con lo que ya subiste, o contradice algo del canon (`BIBLIA_DEL_UNIVERSO.md` §3)?

---

## 6. Bio lista para copiar (rellena solo lo que sea cierto hoy)
...
## 9. Relación con el resto del repositorio
